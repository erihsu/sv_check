...
pub enum TokenKind {
    ...
    KwPrimCmos, KwPrimMos, KwPrimEn, KwPrimIn, KwPrimOut, KwPrimTran, KwPrimTranif, KwNettype,
...
impl fmt::Display for TokenKind {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            TokenKind::KwNetType         => write!(f, "Kw:net-type"    ),
            ...
            TokenKind::KwFinal           => write!(f, "Kw:final"       ),
            ...
            TokenKind::KwProperty        => write!(f, "Kw:property"    ),
            TokenKind::KwEndProperty     => write!(f, "Kw:endproperty" ),
            ...
            TokenKind::KwPrimCmos        => write!(f, "Kw:PrimitiveCmos"   ),
            TokenKind::KwPrimMos         => write!(f, "Kw:PrimitiveMos"    ),
            TokenKind::KwPrimEn          => write!(f, "Kw:PrimitiveEn"     ),
            TokenKind::KwPrimIn          => write!(f, "Kw:PrimitiveIn"     ),
            TokenKind::KwPrimOut         => write!(f, "Kw:PrimitiveOut"    ),
            TokenKind::KwPrimTran        => write!(f, "Kw:PrimitiveTran"   ),
            TokenKind::KwPrimTranif      => write!(f, "Kw:PrimitiveTranif" ),
...
pub fn keyword_from_str(w: &str) -> Option<TokenKind> {
    match w {
        ...
        "buf"                 => Some(TokenKind::KwPrimOut    ),
        "bufif0"              => Some(TokenKind::KwPrimEn   ),
        "bufif1"              => Some(TokenKind::KwPrimEn   ),
        ...
        "cmos"                => Some(TokenKind::KwPrimCmos    ),
        ...
        "deassign"            => Some(TokenKind::KwAssign   ),
        ...
        "endproperty"         => Some(TokenKind::KwEndProperty),
        ...
        "nand"                => Some(TokenKind::KwPrimIn   ),
        "negedge"             => Some(TokenKind::KwEdge     ),
        "nettype"             => Some(TokenKind::KwNettype  ),
        "new"                 => Some(TokenKind::KwNew      ),
        "nexttime"            => Some(TokenKind::Keyword    ),
        "nmos"                => Some(TokenKind::KwPrimMos  ),
        "nor"                 => Some(TokenKind::KwPrimIn   ),
        "noshowcancelled"     => Some(TokenKind::Keyword    ),
        "not"                 => Some(TokenKind::KwPrimIn   ),
        "notif0"              => Some(TokenKind::KwPrimEn   ),
        "notif1"              => Some(TokenKind::KwPrimEn   ),
        ...
        "rcmos"               => Some(TokenKind::KwPrimCmos ),
        "ref"                 => Some(TokenKind::KwRef      ),
        "reg"                 => Some(TokenKind::KwReg      ),
        "reject_on"           => Some(TokenKind::Keyword    ),
        "release"             => Some(TokenKind::KwAssign   ),
        "repeat"              => Some(TokenKind::KwRepeat   ),
        "restrict"            => Some(TokenKind::Keyword    ),
        "return"              => Some(TokenKind::KwReturn   ),
        "rnmos"               => Some(TokenKind::KwPrimMos  ),
        "rpmos"               => Some(TokenKind::KwPrimMos  ),
        "rtran"               => Some(TokenKind::KwPrimTran ),
        "rtranif0"            => Some(TokenKind::KwPrimTranif),
        "rtranif1"            => Some(TokenKind::KwPrimTranif),
        ...
        "tran"                => Some(TokenKind::KwPrimTran ),
        "tranif0"             => Some(TokenKind::KwPrimTranif),
        "tranif1"             => Some(TokenKind::KwPrimTranif),
        ...
        "xnor"                => Some(TokenKind::KwPrimIn   ),
        "xor"                 => Some(TokenKind::KwPrimIn   ),
